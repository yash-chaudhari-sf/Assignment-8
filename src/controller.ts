...
class controller {
  public async getAll(req: Request, res: Response) {
    pool.query(
      `SELECT users.id,firstname,middlename,lastname,email,
  ...
  public async getUserById(req: Request, res: Response) {
    ...
    pool.query(
      `SELECT users.id,firstname,middlename,lastname,email,phone,
  ...
  public async createUser(req: Request, res: Response) {
    ...
    pool.query(
      `INSERT INTO users(firstname,middlename,lastname,email,phone,role,
            address,customerid) VALUES ($1,$2,$3,$4,$5,$6,$7,$8)`,
      [firstName, middleName, lastName, email, phone, role, address, customer],
      (err, result) => {
        if (err) {
          throw err;
        } else {
  ...
  public async updateUser(req: Request, res: Response) {
    ...
    pool.query(
      `UPDATE users SET firstname = $1, middlename = $2, lastname = $3, email = $4,
